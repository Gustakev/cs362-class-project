...
class TestMainMenuUI(unittest.TestCase):
    ...
    def test_main_menu_routes_to_settings(
        self, mock_settings, mock_input, mock_print
    ):
        with self.assertRaises(SystemExit):
            main_menu()
    ...
    def test_load_backup_manual_path(
    ...
    @patch('cli_components.main_menu.get_export_destination',
